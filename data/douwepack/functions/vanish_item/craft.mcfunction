...
execute at @e[tag=craftitemB_1] run execute at @e[distance=0..1,sort=nearest,tag=craftitemB_2] run summon item ~ ~0.1 ~ {Item:{id:"carrot_on_a_stick",Count:1b,tag:{Tags:["fresh_item"],CustomModelData:20201,vanishitem:1b}}}
